...
export const Weibo = ({size = DEFAULT_SIZE}): JSX.Element => (
	<span aria-label="weibo" title="weibo">
		<svg
...
export const Wechat = ({size = DEFAULT_SIZE}): JSX.Element => (
	<span aria-label="wechat" title="wechat">
		<svg
			viewBox="64 64 896 896"
			focusable="false"
			data-icon="wechat"
...
export const Twitter = ({size = DEFAULT_SIZE}): JSX.Element => (
...
export const Facebook = ({size = DEFAULT_SIZE}): JSX.Element => (
