...
const SharedSelectText = ({
  ...
  const updateShared = () => {
    ...
    if (
      selected.text.trim().length && selected.selection.containsNode(slotRef.current, true)
    ) {
...
SharedSelectText.propTypes = {
  children: PropTypes.element.isRequired | PropTypes.string.isRequired,
  timeout: PropTypes.number,
  buttons: PropTypes.arrayOf(PropTypes.shape({
    icon: PropTypes.string.isRequired | PropTypes.element.isRequired,
    onClick: PropTypes.func
  })),
  buttonsRender: PropTypes.element,
